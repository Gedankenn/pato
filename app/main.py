...
.header .logo{{height:60px;margin-bottom:4px}}
...
<body>
<div class="box">
<img src="/static/logo.png" style="width:50%;max-width:320px;margin-bottom:8px"><h1>PatoAgenda AI</h1><p>Agendamentos Inteligentes</p>
